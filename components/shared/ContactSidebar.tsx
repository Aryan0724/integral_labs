            ...
            <div className="space-y-8">
               ...
               <div className="space-y-4">
                  ...
                  <a href="tel:+919470650991" className="flex items-center gap-4 p-4 rounded-xl border border-white/5 hover:border-white/20 hover:bg-white/[0.02] transition-all text-white/60 hover:text-white">
                     <Phone size={18} />
                     <span className="text-sm">+91 94706 50991</span>
                  </a>
                  <a href="tel:+919389307062" className="flex items-center gap-4 p-4 rounded-xl border border-white/5 hover:border-white/20 hover:bg-white/[0.02] transition-all text-white/60 hover:text-white">
                     <Phone size={18} />
                     <span className="text-sm">+91 93893 07062</span>
                  </a>
               </div>
